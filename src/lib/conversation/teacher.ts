...
export function buildSystemPrompt(
	...
	const rules = [
		...
		`The learner may have no ${target} keyboard. Writing ${target} in Latin-script romanization is normal input, not a mistake: read it phonetically, be generous about spelling, spacing, tone marks and accents, and answer what they meant. Never correct them for having written in romanization.`,
		...
		`"correction" is about the learner's last message only, and about their ${target} and nothing else: grammar, spelling, agreement, word choice, unnatural phrasing. It is never a comment on what they said. If they ask for a pizza in an ice cream shop, you answer in character that you only have ice cream and set "correction" to null — ordering the wrong thing is not a language mistake.`,
